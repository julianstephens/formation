...
export function useDashboardSessions() {
    ...
    return useQuery({
        ...
        queryFn: async (): Promise<DashboardSession[]> => {
            ...
            const unifiedSeminarSessions: DashboardSession[] =
                seminarSessionsArrays.flat().map((session) => {
            ...
            const unifiedTutorialSessions: DashboardSession[] =
                tutorialSessionsArrays.flat().map((session) => {
